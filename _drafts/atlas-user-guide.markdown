...
![](/public/img/dbproxy/33821.jpg)

![](/public/img/dbproxy/33822.jpg)
...
<tr>
	<th>access-num-per-time-window</th>
	<th>一个时间窗口内某条语句允许执行的次数</th>
</tr>
<tr>
	<th>admin-address</th>
	<th>dbproxy开发的Admin端口</th>
</tr>
<tr>
...
<tr>
	<th>auto-filter-flag</th>
	<th>控制自动加入到黑名单的规则默认是否生效</th>
</tr>
<tr>
	<th>backend-max-thread-running</th>
	<th>每个MySQL端并发查询的最大阈值</th>
</tr>
<tr>
	<th>backend-monitor-pwds</th>
	<th>用于监控MySQL状态而设置的连接MySQL的登录密码</th>
</tr>
<tr>
	<th>basedir</th>
	<th>dbproxy的工作目录</th>
...
<tr>
	<th>check-state-conn-timeout</th>
	<th>检查状态连接的超时</th>
</tr>
<tr>
	<th>daemon</th>
	<th>TRUE dbproxy后台运行；FALSE dbproxy前台运行</th>
</tr>
<tr>
	<th>db-connection-idle-timeout</th>
	<th>dbproxy连接池中空闲连接的timeout（单位s），超时则该连接从连接池被释放</th>
</tr>
<tr>
	<th>db-connection-max-age</th>
	<th>连接池中连接的生存周期</th>
</tr>
<tr>
	<th>event-threads</th>
...
<tr>
	<th>instance</th>
	<th>当前dbproxy实例的名字</th>
</tr>
<tr>
	<th>keepalive</th>
	<th>	TRUE:开启守护进程 FALSE:不开始守护进程 (守护进程会在dbproxy退出时重启dbproxy)	</th>
</tr>
<tr>
	<th>lastest-query-num</th>
	<th>过滤功能中，计算某类语句的频率时需要将语句保存到链表，该值表示该链表保留语句的上限</th>
</tr>
<tr>
	<th>log-level</th>
	<th>设置日志级别 (日志级别依次升高：message warning critical error info debug)</th>
</tr>
<tr>
	<th>log-path</th>
	<th>日志文件所在的目录</th>
...
<tr>
	<th>long-query-time</th>
	<th>慢查询的阈值，超过该值则认定为慢查询（单位ms）</th>
</tr>
<tr>
	<th>long-wait-time</th>
	<th>长等待的阈值，超过该值则认定为同步等待时间过长，打印warning（单位ms）</th>
</tr>
<tr>
	<th>manual-filter-flag</th>
	<th>控制手动加入到黑名单的规则默认是否生效</th>
</tr>
<tr>
	<th>max-connections</th>
	<th>并发连接dbproxy的连接数最大阈值</th>
</tr>
<tr>
	<th>max-open-files</th>
	<th>dbproxy打开的最大文件句柄数，默认为ulimit -n 的值</th>
</tr>
<tr>
	<th>mysql-version</th>
	<th>设置的dbproxy连接的MySQL的版本号</th>
</tr>
<tr>
	<th>percentile-switch</th>
	<th>percentile统计的开关</th>
</tr>
<tr>
	<th>percentile-value</th>
	<th>percentile 的百分数，默认95</th>
</tr>
<tr>
	<th>plugins</th>
	<th>dbproxy加载的插件的名称</th>
</tr>
<tr>
	<th>proxy-address</th>
	<th>dbproxy开发的Proxy端口</th>
</tr>
<tr>
	<th>query-filter-frequent-threshold</th>
	<th>
		设置某类语句记入黑名单时，要满足的查询的执行频率，超过此值的查询会被做为放到黑名单的候选，当同时满足时间和频率都超过指定值时，此类查询会被放入黑名单
	</th>
</tr>
<tr>
	<th>query-filter-time-threshold</th>
	<th>设置某类语句记入黑名单时，要满足的查询的执行时间，超过此值的查询会被做为放到黑名单的候选(单位ms)</th>
</tr>
<tr>
	<th>query-response-time-range-base</th>
	<th>设置 dbproxy 中记录响应时间的对数的基数，默认为 2</th>
</tr>
<tr>
	<th>query-response-time-stats</th>
	<th>
		设置查询响应时间统计的级别，0：不统计，1：仅统计总体的响应时间，其中包括慢查询，2：进行直方图统计；默认为1 
	</th>
</tr>
<tr>
	<th>remove-backend-timeout</th>
	<th>移除backend最大等待时间</th>
</tr>
<tr>
	<th>select-where-limit</th>
	<th>是否限制WHERE语句。ON: SELECT 后必须有WHERE 语句</th>
</tr>
<tr>
	<th>shutdown-timeout</th>
	<th>shutdown dbproxy时最大等待时间</th>
</tr>
<tr>
	<th>sql-log</th>
	<th>SQL日志所在的路径</th>
...
<tr>
	<th>sql-log-file-num</th>
	<th>dbproxy中保留的SQL日志文件的最大个数</th>
</tr>
<tr>
	<th>sql-log-file-size</th>
	<th> 设置单个SQL文件的大小的最大值</th>
</tr>
<tr>
	<th>sql-log-mode</th>
	<th>
...
<tr>
	<th>sql-log-slow-ms</th>
	<th>查询在mysql执行时间超过这个值的查询会被记到backend的SQL日志中，单位是 ms, 默认为0, 代表全部打印</th>
</tr>
<tr>
	<th>thread-running-sleep-delay</th>
	<th>用于指定当 backend 的 thread running 数超过 backend-max-thread-running时，新来连接等待的时间（单位ms）
	</th>
</tr>
<tr>
	<th>user</th>
	<th>用于监控MySQL状态而设置的连接MySQL的登录用户名</th>
</tr>
<tr>
	<th>version</th>
	<th>dbproxy版本信息</th>
...
<tr>
	<th>wait-timeout</th>
	<th>设置 dbproxy 客户端连接的 timeout，如果连接到 dbproxy 的连接空闲超过此值，dbproxy 会关闭此连接（单位ms）
	</th>
</tr>
</table>
...
<tr>
	<th>DB_connections_cached</th>
	<th>缓存的后台db连接数</th>
</tr>
<tr>
	<th>Net_client_read_packets</th>
	<th>客户端读的数据包的个数</th>
</tr>
<tr>
	<th>Net_server_write_packets</th>
	<th>服务器端写的数据包的个数</th>
</tr>
<tr>
	<th>DB_connections</th>
	<th>正在使用的后台db连接数</th>
</tr>
<tr>
	<th>Percentile</th>
	<th>查询的percentile的值，后可跟参数，可以查询最近 X时间内的percentile的值</th>
</tr>
<tr>
	<th>Com_query_write</th>
	<th>处理的写语句的个数</th>
</tr>
<tr>
...
<tr>
	<th>Closed_clients</th>
	<th>正常关闭的连接数</th>
</tr>
<tr>
	<th>Com_query_read</th>
	<th>处理的读语句的个数</th>
</tr>
<tr>
	<th>Com_query_read_sent</th>
	<th>向后台db发送的度语句的个数</th>
</tr>
<tr>
	<th>Net_server_write</th>
	<th>服务器端写的字节数</th>
</tr>
<tr>
	<th>Max_connections</th>
	<th>连接dbproxy的最大连接数</th>
</tr>
<tr>
	<th>Connections</th>
	<th>当前的连接数</th>
...
<tr>
	<th>Slow_query_total_time</th>
	<th>慢查询的总响应时间</th>
</tr>
<tr>
	<th>Net_server_read_packets</th>
	<th>服务器端读的数据包的个数</th>
</tr>
<tr>
	<th>Attempted_connects</th>
	<th>连接总数</th>
</tr>
<tr>
	<th>Net_server_read</th>
	<th>服务器端读的字节数</th>
</tr>
<tr>
	<th>Threads_running</th>
...
<tr>
	<th>Com_query_write_sent</th>
	<th>向后台db发送的写语句的个数</th>
</tr>
<tr>
	<th>Net_client_write_packets</th>
	<th>客户端写的数据包的个数</th>
</tr>
<tr>
	<th>Net_client_write</th>
	<th>客户端写的字节数</th>
</tr>
<tr>
	<th>Com_other</th>
...
<tr>
	<th>lastest_query_times</th>
	<th>最近的一个时间窗口时间内的查询次数</th>
</tr>
</table>
